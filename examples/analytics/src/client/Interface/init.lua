...
-- Remotes:
local CreateLink = ReplicatedStorage:WaitForChild("CreateLink") :: RemoteFunction
				...
				[Children] = {
					...
					New("TextButton")({
						...
						[OnEvent("Activated")] = function()
							local Link = CreateLink:InvokeServer(UserId)
					...
					New("TextBox")({
						...
						CursorPosition = -1,
						FontFace = Font.new("rbxasset://fonts/families/FredokaOne.json"),
						PlaceholderText = "Creator's UserId",
						Text = "",
						TextColor3 = Color3.fromRGB(255, 255, 255),
						TextScaled = true,
						TextSize = 16,
